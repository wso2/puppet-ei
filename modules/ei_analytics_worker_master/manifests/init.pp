...
# Class: ei_analytics_worker_master
# Init class of Enterprise Integrator Analytics - Worker profile
class ei_analytics_worker_master inherits ei_analytics_worker_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_analytics_worker_master -> files
  */
