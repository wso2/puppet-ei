...
puppet apply -e "include ei_analytics_worker_master" --modulepath=${puppet_env}/modules
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/ei_analytics_worker/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/ei_analytics_worker_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
