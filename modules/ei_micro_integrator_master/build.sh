...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/ei_micro_integrator/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/ei_micro_integrator_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
