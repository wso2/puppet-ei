...
# Class: ei_micro_integrator_master
# Init class of EI Integrator - Micro Integrator profile
class ei_micro_integrator_master inherits ei_micro_integrator_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_micro_integrator_master -> files
  */
