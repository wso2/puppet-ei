...
puppet apply -e "include ei_broker_master" --modulepath=${puppet_env}/modules
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/ei_broker/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/ei_broker_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
