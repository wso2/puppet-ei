...
# Class: ei_integrator_master
# Init class of EI Integrator default profile
class ei_integrator_master inherits ei_integrator_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> ei_integrator_master -> files
  */
